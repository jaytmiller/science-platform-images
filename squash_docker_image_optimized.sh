...
#
# USAGE:
#   ./squash_docker_image_optimized.sh <source_image> <target_image>
#
# DEPENDENCIES:
#   - docker
...
main() {
  ...
  echo "Step 2: Flattening '$SOURCE_IMAGE' into temporary base image '$TEMP_BASE_IMAGE'ப்பான"
  local container_id
  ...
  echo "Step 5: Building final squashed image '$TARGET_IMAGE'ப்பான"
